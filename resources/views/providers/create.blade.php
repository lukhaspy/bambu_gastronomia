@extends('layouts.app', ['page' => 'Proveedor', 'pageSlug' => 'provider', 'section' => 'providers'])
@section('content')
                    ...
                    <form method="post" action="{{ route('providers.store') }}" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="form-group{{ $errors->has('ruc') ? ' has-danger' : '' }} col-md-3">
                                ...
                                <input type="text" name="ruc" id="input-ruc" class="form-control form-control-alternative{{ $errors->has('ruc') ? ' is-invalid' : '' }}" value="{{ old('ruc') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('razon') ? ' has-danger' : '' }} col-md-5">
                                ...
                                <input type="text" name="razon" id="input-razon" class="form-control form-control-alternative{{ $errors->has('razon') ? ' is-invalid' : '' }}" value="{{ old('razon') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }} col-md-3">
                                ...
                                <input type="phone" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" .." value="{{ old('phone') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('obs') ? ' has-danger' : '' }} col-md-12">
                                ...
                                <textarea name="obs" id="input-obs" class="form-control form-control-alternative{{ $errors->has('obs') ? ' is-invalid' : '' }}" value="{{ old('obs') }}"></textarea>
