                    ...
                    <form method="post" action="{{ route('providers.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('ruc') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="ruc" id="input-ruc" class="form-control form-control-alternative{{ $errors->has('ruc') ? ' is-invalid' : '' }}" placeholder="ruc" value="{{ old('ruc') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('razon') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="razon" id="input-razon" class="form-control form-control-alternative{{ $errors->has('razon') ? ' is-invalid' : '' }}" placeholder="Razon" value="{{ old('razon') }}" required autofocus>
                                @include('alerts.feedback', ['field' => 'razon'])
                            </div>
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-name">Nombre Común</label>
                                <input type="text" name="name" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name" value="{{ old('name') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                ...
                                <input type="phone" name="phone" id="input-phone" class="form-control form-control-alternative{{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="0983..." value="{{ old('phone') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('obs') ? ' has-danger' : '' }}">
                                ...
                                <textarea name="obs" id="input-obs" class="form-control form-control-alternative{{ $errors->has('obs') ? ' is-invalid' : '' }}" placeholder="" value="{{ old('obs') }}"></textarea>
