@extends('layouts.app', ['page' => 'Nuevo Ingreso', 'pageSlug' => 'incomes', 'section' => 'transactions'])
                    ...
                    <form method="post" action="{{ route('transactions.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group{{ $errors->has('amount') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" step=".01" name="amount" id="input-amount" class="form-control form-control-alternative" value="{{ old('amount') }}" min="0" required>
