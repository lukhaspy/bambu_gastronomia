@extends('layouts.app', ['page' => 'Editar Gasto', 'pageSlug' => 'expenses', 'section' => 'transactions'])
                    ...
                    <form method="post" action="{{ route('transactions.update', $transaction) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" __('Title') }}" value="{{ old('title', $transaction->title) }}" required autofocus>
