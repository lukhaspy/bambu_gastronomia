@extends('layouts.app', ['page' => 'Editar Usuario', 'pageSlug' => 'users', 'section' => 'users'])
                    ...
                    <form method="post" action="{{ route('users.update', $user) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" for="input-password-confirmation">Repetir Contraseña</label>
