<h6 class="heading-small text-muted mb-4">Información del Funcionario</h6>
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-group{{ $errors->has('surname') ? ' has-danger' : '' }}">
            <label class="form-control-label" for="input-surname">Apellido</label>
            {!! Form::text('surname', null, ['class' => 'form-control form-control-alternative '.($errors->has('surname') ? 'is-invalid' : ''), 'placeholder' => 'Apellido', 'autofocus']) !!}
